...
export function GroupPage({
  ...
  return (
    <div className="os-app-stack">
      <Head title={group.name} meta={group.kind === "account" ? "A client's group" : undefined}>
        <Button tone="quiet" onClick={onBack} ariaLabel="Back to Groups">
          <ArrowLeft size={13} aria-hidden /> Groups
        </Button>
