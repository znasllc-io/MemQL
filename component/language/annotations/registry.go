...
var ByReceiver = map[string][]string{
	"Query": {
		"description", "enabled", "disabled", "public", "serverOnly", "mcp", "unbounded", "cache", "nocache", "latestMode", "actor", "requiresRank", "requiresCapability",
	},
	"Mutation": {
	...
	"Logic": {
		"description", "enabled", "disabled", "eventField", "actor", "requiresRank", "requiresCapability",
	},
	"Automation": {
